        ...
        <div className="projects-container" id="projects">
          <section className="projects-section">
            ...
            <section className="projects-grid md:grid md:grid-cols-2 md:gap-5">
              <section className="project-card transition-transform duration-300 hover:scale-105">
                <h2>Othello Game + AI Bot</h2>
                <section className="grid grid-cols-2">
                  <Image
                    src={othello_runner}
                    alt="Riya Dev AI othello project starting screen"
                  />
                  <Image
                    src={othello}
                    alt="Riya Dev AI othello project game video"
                  />
                </section>
              ...
              <section className="project-card transition-transform duration-300 hover:scale-105">
                ...
                <section className="grid grid-cols-2">
                  <Image
                    src={shortest_path_railroad}
                    alt="Riya Dev AI railroad project"
                  />
                  <Image
                    src={shortest_path_railroad_blue}
                    alt="Riya Dev AI railroad project"
                  />
                  <Image
                    src={shortest_path_railroad_orange}
                    alt="Riya Dev AI railroad project"
                  />
                  <Image
                    src={shortest_path_railroad_pink}
                    alt="Riya Dev AI railroad project"
                  />
                </section>
              ...
              <section className="project-card transition-transform duration-300 hover:scale-105">
                ...
                <Image
                  ...
                  alt="Riya Dev Movie Match project"
                />
                <h3>
                  Python • Flask • APIs • Next.js • React • SASS • TypeScript •
                  CSS • Vercel
                </h3>
              </section>
              ...
              <section className="project-card transition-transform duration-300 hover:scale-105">
                <h2 className="text-sm leading-9">
                  Researching Progression of Alzheimer's Disease with Calcium
                  Ion Concentration Algorithms
                </h2>
                <Image
                  src={assip}
                  style={{ width: "60%", height: "auto" }}
                  alt="Riya Dev ASSIP Internship Project Alzheimer's Cells Video"
                />
                <h3>
                  Java • Python (NumPy • Pandas • Matplotlib) • MATLAB • Spyder
                  • Anaconda • FORTRAN
                </h3>
              </section>
              ...
              <section className="project-card transition-transform duration-300 hover:scale-105">
                ...
                <section className="grid grid-cols-10">
                  <div className="col-span-4">
                    <Image
                      src={coin_detection_bw}
                      alt="Riya Dev CV Coin Detection Project"
                    />
                  </div>
                  <div className="col-span-6">
                    <Image
                      src={coin_detection_identification}
                      alt="Riya Dev CV Coin Detection Project"
                    />
                  </div>
                </section>
                <Image
                  src={coin_detection_results}
                  alt="Riya Dev CV Coin Detection Project results"
                />
                <h3>
                  OpenCV • C++ • Hysterisis • Double Threshold • Intensity
                  Gradients
                </h3>
              </section>
              ...
              <section className="project-card transition-transform duration-300 hover:scale-105">
                ...
                <Image
                  src={frat_app}
                  style={{ width: "60%", height: "auto" }}
                  alt="Riya Dev Zeta Pi Professional Technology Fraterity Mobile App Development Project"
                />
              ...
              <section className="project-card transition-transform duration-300 hover:scale-105">
                ...
                <Image
                  src={rotating_platonic_solid}
                  style={{ width: "70%", height: "auto" }}
                  alt="Riya Dev CV 3D Platonic Rotating Solid Project"
                />
              ...
              <section className="project-card transition-transform duration-300 hover:scale-105">
                <h2>FITTED</h2>
                <Image src={fitted} alt="Riya Dev V1 Michigan FITTED Project" />
                <h3>
                  Python • BeautifulSoup Library • Supabase • Next.js • React •
              ...
              <section className="project-card transition-transform duration-300 hover:scale-105">
                ...
                <Image src={sudoku} alt="Riya Dev AI Sudoku Solver Project" />
              ...
              <section className="project-card transition-transform duration-300 hover:scale-105">
                ...
                <section className="grid grid-cols-4">
                  <Image
                    src={janus_load}
                    alt="Riya Dev Mobile/Web Application Development Research Lab Social Media Mobile Application Project"
                  />
                  <Image
                    src={janus_login}
                    alt="Riya Dev Mobile/Web Application Development Research Lab Social Media Mobile Application Project"
              ...
              <section className="project-card transition-transform duration-300 hover:scale-105">
                ...
                <Image
                  src={this_website}
                  alt="Riya Dev Personal Website project"
                />
